    ...
    return (
        <div className='experiment-container mb-16 flex flex-col items-center justify-center'>
            <div className='mb-2 flex w-full justify-center'>
                <div onClick={handleChange} className={`schema${schema} h-6 w-1/2 cursor-pointer rounded-md p-2`}></div>
                <div onClick={handleZoom} className={`cursor-pointer rounded-md px-6`}>
                    {
                        bigSize ? <MdZoomInMap className='rounded-md text-neutral-600 dark:text-white/75' size={21} />
                            : <MdOutlineZoomOutMap className='rounded-md text-neutral-600 dark:text-white/75' size={21} />
                            ...
                            <Tippy duration={[0, 0]}
                                ...
                                content={
                                    <div className="pixel-grid-tooltip" >
                                        ...
                                        <div className='tooltip-scrobbles'>
                                            {squares.count}
                                        </div>
                                    </div>
                                }
                                ...
                                <button
                                    ...
                                    style={{ transition: `background-color 0.1s ease ${delay.toFixed(4)}s, min-width 0.25s ease, min-height 0.25s ease;` }}
                                >
