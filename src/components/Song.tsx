            ...
            >
                ...
                <div className="move-position">
                    ...
                    <div className="w-full h-[6rem] flex flex-row items-center justify-start">
                        ...
                        <a href={user.spotify.album_art_url} rel="noreferrer" target="_blank"
                            className="hover:scale-125 transition duration-500 hover:ease-out"
                        >
                            <img
                        ...
                        <div className="w-56 h-full flex flex-col items-start justify-center">
                            ...
                            <p className="w-full text-gray-800 dark:text-[#cad2e0] font-normal text-sm truncate relative"
                                title={user.spotify.artist.replace(/;/g, ',')}
                            >
                                by {user.spotify.artist.replace(/;/g, ',')}
                            </p>
                            <p className="w-full text-black-900 dark:text-[#cad2e0] font-normal text-sm truncate relative"
