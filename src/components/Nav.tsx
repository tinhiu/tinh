	...
	return (
		<>
			<motion.div
				...
				className="sticky top-5 z-[10] mx-auto mt-4 hidden w-[90%] flex-row items-center justify-between rounded-lg bg-white/60 px-4 py-2 shadow-md backdrop-blur-lg dark:border-white/30 dark:bg-[#5f5555ad] sm:flex md:mt-8 md:w-[50rem]"
			>
				...
				{isOpen && (
					<>
						<motion.nav
							...
							className="justify-content fixed top-0 z-[500] flex h-screen w-full flex-col items-center overflow-hidden bg-black/10 backdrop-blur-md sm:hidden"
						/>
						...
						<motion.div
							...
							className="fixed top-0 z-[700] mt-16 flex h-auto w-full flex-col items-center justify-start border-slate-800/30
